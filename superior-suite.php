                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <ul class="list_detalle_h">
                                ...
                                <li class="item_detalle home__photo8">2 unidades con chimenea</li>
                                <li class="item_detalle home__photo9">1 unidad con jacuzzi</li>
                            </ul>
                            ...
                            <p class="txt_general home__photo11">Todas nuestras habitaciones cuentan con 1 cama king size y su ocupación es de 2 adultos.</p>
                            ...
                            <p class="txt_general home__photo12">*Es necesaria previa reservación <br>
