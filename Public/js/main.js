...
function animationScroll(){
    ...
    sr.reveal(`.home__left1`,{origin: 'left', interval: 100, delay: 100})
    sr.reveal(`.home__left2`,{origin: 'left', interval: 100, delay: 200})
    sr.reveal(`.home__left3`,{origin: 'left', interval: 100, delay: 300})
    sr.reveal(`.home__left4`,{origin: 'left', interval: 100, delay: 400})
    sr.reveal(`.home__left5`,{origin: 'left', interval: 100, delay: 500})

    sr.reveal(`.home__right1`,{origin: 'right', interval: 100, delay: 100})
    sr.reveal(`.home__right2`,{origin: 'right', interval: 100, delay: 200})
    sr.reveal(`.home__right3`,{origin: 'right', interval: 100, delay: 300})
    sr.reveal(`.home__right4`,{origin: 'right', interval: 100, delay: 400})
    sr.reveal(`.home__right5`,{origin: 'right', interval: 100, delay: 500})
    sr.reveal(`.home__right6`,{origin: 'right', interval: 100, delay: 600})
    sr.reveal(`.home__right7`,{origin: 'right', interval: 100, delay: 700})
    sr.reveal(`.home__right8`,{origin: 'right', interval: 100, delay: 800})
    sr.reveal(`.home__right9`,{origin: 'right', interval: 100, delay: 900})
    sr.reveal(`.home__right10`,{origin: 'right', interval: 100, delay: 1000})
    sr.reveal(`.home__right11`,{origin: 'right', interval: 100, delay: 1100})
    sr.reveal(`.home__right12`,{origin: 'right', interval: 100, delay: 1200})
