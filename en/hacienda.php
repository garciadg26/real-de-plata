...
<body>
    ...
    <section class="subtit_hacienda" id="subtit_hacienda">
        <div class="cont_tit_hacienda">
            <h2 class="tit_primero home__photo1"><span class="capitular_red">G</span>rand Hacienda & a world heritage site dating from the XVI century, located on what was known as “Ruta de la Plata” meaning the Silver Route.</h2>
        </div>
        <div class="cont_txt_hacienda home__photo2">
            <p class="txt_general">A place full of history where you will experience nature with the luxury and exclusivity of a traditional Hacienda.</p>
            <p class="txt_general">Enjoy a completely pleasant experience, far from the city and in a unique historical and countryside environment.</p>
            <p class="txt_general">Massage room* / Gym / Bar / Bicycles / Outdoor Jacuzzi / Yoga classes /  Transportation to and from the airport / Golf practice range.</p>
        </div>
    </section>
    ...
    <section class="chichimequillas" id="chichimequillas">
        <div class="cont_chicimequillas">
            ...
            <div class="right_txt_chi home__photo5">
                <h1 class="tit_primero"><span class="capitular_red">T</span>he Great Hacienda of Chichimequillas</h1>
    ...
    <section class="gale_photo" id="galeria_photo">
        <div class="cont_tit_gallery">
            <h1 class="tit_primero"><span class="capitular_red">G</span>allery</h1>
        </div>
    ...
    <!-- FANCYBOX -->
    <script type="text/javascript" src="<?php echo constant('URL') ?>Public/js/jquery-1.4.3.min.js"></script>
    <script type="text/javascript" src="<?php echo constant('URL') ?>Public/js/jquery.fancybox-1.3.4.pack.js"></script>
    <script type="text/javascript" src="<?php echo constant('URL') ?>Public/js/jquery.mousewheel-3.0.4.pack.js"></script>
    <script type="text/javascript" src="<?php echo constant('URL') ?>Public/js/popFancy.js"></script>
