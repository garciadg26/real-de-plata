<?php $title = "Políticas de cancelación - Mesón Real De Plata"; ?>
...
<body>
    ...
    <section class="encabezado_hacienda text-center" id="encab_hacienda">
        ...
        <h2 class="tit_primero_red max-w900">Políticas de cancelación</h2>
    </section>

    <!-- DESCRIPCIÓN -->
    <section id="aviso_p" class="a_privacidad">
        <div class="container text-center">
            <h4 class="tit_primero">Casos y escenarios de cancelación.</h4> <br><br>
